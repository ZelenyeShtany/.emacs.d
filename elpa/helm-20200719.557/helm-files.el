...
(defvar helm-find-files-map
  (let ((map (make-sparse-keymap)))
    ...
    (define-key map (kbd "C-l") 'helm-ff-run-toggle-auto-update)
    ...
    (define-key map (kbd "C-<backspace>")           'helm-find-files-up-one-level)
...

;; Internal.
(defvar helm-find-files-doc-header " (\\<helm-find-files-map>\\[helm-find-files-up-one-level]: Go up one level) (C-c r: Open as root)"
