...
;; Package-Version: 20200707.1108
;; Package-Commit: 92bf4e0298c39d43c1a057a8fb29be76dae3e863
...
(defvar wg-prefixed-map
  (wg-fill-keymap
   ...
   (kbd "r")          'wg-rename-workgroup
   ;;(kbd "s")        'wg-switch-to-workgroup
...
;;   (kbd "9")          'wg-switch-to-workgroup-at-index-9
   ;;(kbd "<left>")        'wg-switch-to-workgroup-left
   ;;(kbd "p")          'wg-switch-to-workgroup-left
   ;;(kbd "C-n")        'wg-switch-to-workgroup-right
   ;;(kbd "<right>")          'wg-switch-to-workgroup-right
